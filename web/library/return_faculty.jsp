<%-- 
    Document   : return_faculty
    Created on : Jun 30, 2011, 1:07:32 PM
        ...
        <div class="page-container">
            ...
            <div class="main">
                ...
                <div class="main-content">
                    <h1 class="pagetitle">Return Book - Faculty</h1>
                    <%
                    ...
                    %>
                    <div id="errors"></div>
                    <form action="return_faculty2" method="post" onsubmit="return validate()">
                        <table>
                            <tr>
                                <td>Employee ID</td>
