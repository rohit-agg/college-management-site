<%-- 
    Document   : new_allowed_subject
    Created on : Jun 28, 2011, 11:22:08 PM
...
<html>
    <head>
        ...
        <title>College Management System - New Allowed Subject</title>
        ...
        <script type="text/javascript">
            ...
            function validate()
            {
                ...
                {
                     errors_tag.innerHTML += "<li>Semester must be a greater than 0.</li>";
                     error = true;
                }
        ...
        <div class="page-container">
            ...
            <div class="main">
                ...
                <div class="main-content">
                    <h1 class="pagetitle">Subject Allowed - New</h1>
                    <%
                    ...
                    %>
                    <div id="errors"></div>
                    <form action="new_allowed_subject2" method="post" onsubmit="return validate()">
                        <table>
                            <tr>
                                <td>Subject Code</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="category" id="category">
                                        <option <% if(category.compareTo("Main") == 0) { out.write("selected"); }%> >Main</option>
                                        <option <% if(category.compareTo("Elective") == 0) { out.write("selected"); }%> >Elective</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
